...
import { ArrowLeft, Camera, ChevronDown, FileText, Upload } from 'lucide-react';
    ...
    <div className="min-h-screen bg-background flex flex-col relative">
      ...
      <main className="flex-1 px-4 py-6 max-w-md mx-auto w-full pb-32 space-y-6">
        ...
        <div className="space-y-2 pt-2">
          <label className="text-xs font-bold tracking-wider text-text-muted uppercase">Certificado / Remito (Opcional)</label>
